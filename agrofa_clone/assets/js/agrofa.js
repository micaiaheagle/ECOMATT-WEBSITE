(function ($) {
  ...
  // Date Picker
  if ($(".Agricu-datepicker").length) {
    $(".Agricu-datepicker").each(function () {
      $(this).datepicker();
    });
  }
  ...
  //accrodion
  if ($(".Agricu-accrodion").length) {
    var accrodionGrp = $(".Agricu-accrodion");
        ...
        $(this)
          ...
          .on("click", function () {
            if ($(this).parent().hasClass("active") === false) {
              $(".Agricu-accrodion." + accrodionName)
                .find(".accrodion")
                .removeClass("active");
              $(".Agricu-accrodion." + accrodionName)
                .find(".accrodion")
  ...
  function thmOwlInit() {
    // owl slider
    let AgricuowlCarousel = $(".Agricu-owl__carousel");
    if (AgricuowlCarousel.length) {
      AgricuowlCarousel.each(function () {
        let elm = $(this);
    ...
    let AgricuowlCarouselNav = $(".Agricu-owl__carousel--custom-nav");
    if (AgricuowlCarouselNav.length) {
      AgricuowlCarouselNav.each(function () {
        let elm = $(this);
  ...
  function thmTinyInit() {
    // tiny slider
    const tinyElm = document.querySelectorAll(".Agricu-tiny__slider");
  ...
  //Strech Column
  function Agricu_stretch() {
    var i = $(window).width();
    $(".row .Agricu-stretch-element-inside-column").each(function () {
      var $this = $(this),
